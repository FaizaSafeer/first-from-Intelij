...
public class Degree {
    ...
    high school diploma"".
    Class 'Degree' has 2 subclasses namely 'Bachelors' and Masters’. In Masters class override method
    'getPrerequisite'.
...
@Override
    void getPrerequisite(){
        System.out.println("To get Masters degree you need Bachelors");
}}
class DegreeTest{
